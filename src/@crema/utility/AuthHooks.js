...
import {getUserFromServerAuth} from './helper/AuthHelper';
import {
  useServerAuth,
  useServerAuthActions,
} from '../services/auth/javaServer/ServerAuthProvider';
...
export const useAuthUser = () => {
  ...
  return {
    isLoading,
    isAuthenticated,
    user: getUserFromServerAuth(user),
  };
};
export const useAuthMethod = () => {
  const {signInServerUser, signUpUser, logout} = useServerAuthActions();
